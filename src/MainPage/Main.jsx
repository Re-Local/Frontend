...
// 카테고리 버튼 데이터
const CATS = [
  { label: "Comedy", slug: "comedy", iconType: "comedy" },
  { label: "Romance", slug: "romance", iconType: "romance" },
  { label: "Horror", slug: "horror", iconType: "horror" },
  { label: "Tragedy", slug: "tragedy", iconType: "tragedy" },
  { label: "Thriller", slug: "thriller", iconType: "thriller" },
  { label: "Musical", slug: "musical", iconType: "musical" },
];
        ...
        {CATS.map((c) => (
          <button key={c.slug} className="cat" onClick={() => onPick(c.slug)}>
            <div className="cat-box">
              <div className={`cat-icon ${c.iconType}-icon`}></div>
            </div>
